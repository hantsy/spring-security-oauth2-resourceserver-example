...
To secure your application and interaction between the components in your application, embracing a mature OAuth2/OpenID Connect product is a smart choose.
